...
// Setup Module Mocks
jest.unstable_mockModule("../../app/models/task.js", () => ({ default: MockTask }));
jest.unstable_mockModule("../../app/models/user.js", () => ({ default: MockUser }));
jest.unstable_mockModule("../../app/models/submission.js", () => ({ default: MockSubmission }));
jest.unstable_mockModule("../../app/models/user_task.js", () => ({ default: MockUserTask }));
jest.unstable_mockModule("../../app/models/quiz.js", () => ({ default: MockQuiz }));
jest.unstable_mockModule("../../app/models/neighborhood.js", () => ({ default: MockNeighborhood }));
...
describe("TaskService Verification Logic", () => {
    ...
    test("submit_task - GPS Success", async () => {
        ...
        const task = {
            ...
            base_points: 10,
            verification_criteria: { target_location: [40, -74], min_distance_meters: 100 }
        };
    ...
    test("submit_task - GPS Failure", async () => {
        ...
        await expect(TaskService.submit_task(userId, taskId, proof))
